...
function App() {
  ...
  const carregarRegistros = async (targetPage = page) => {
    ...
    try {
      ...
      pushNotification('success', 'D1 conectado', 'Registros carregados da base financeiro-db.')
    } catch (error) {
  ...
  return (
    <main className="container">
      ...
      <header className="hero">
        ...
        <p className="legend">LCI/CDB IPCA+ com gravação direta na base D1 <strong>financeiro-db</strong>.</p>
      </header>
